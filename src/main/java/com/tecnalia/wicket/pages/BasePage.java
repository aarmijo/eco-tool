...
import com.tecnalia.wicket.assets.base.DocsCssResourceReference;
import com.tecnalia.wicket.assets.base.FixBootstrapStylesCssResourceReference;
import com.tecnalia.wicket.assets.base.HomeCssResourceReference;
import com.tecnalia.wicket.components.site.Footer;
import com.tecnalia.wicket.markup.head.FaviconHeaderItem;
import com.tecnalia.wicket.request.resource.HomeFaviconResourceReference;
...
abstract class BasePage extends GenericWebPage<Void> {
    ...
    protected Navbar newNavbar(String markupId) {
        ...
        // show brand name
        navbar.setBrandName(Model.of("ProSEco Eco-tool"));
        ...
        navbar.addComponents(NavbarComponents.transform(Navbar.ComponentPosition.LEFT,
                        ...
                        new NavbarExternalLink(Model.of("http://www.proseco-project.eu/"))
                                .setLabel(Model.of("ProSEco"))
                                .setTarget(BootstrapExternalLink.Target.blank)
                                .setIconType(GlyphIconType.open),
...
*/
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        response.render(FaviconHeaderItem.forReference(HomeFaviconResourceReference.INSTANCE));                
    }
