...
public class YesNoModalPanel extends Panel {
	...
	public YesNoModalPanel(String id, ModalWindow yesNoModal, PageReference pageReference, String productSystemName) {
		super(id);
		
		Form<?> yesNoForm = new Form<Void>("yesNoForm");
		
        MultiLineLabel messageLabel = new MultiLineLabel("message", "The product system " + productSystemName + " will be deleted!");
		...
		AjaxButton yesButton = new AjaxButton("yesButton", yesNoForm) {
			...
			protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
				if (pageReference != null) ((ProductSystemEditor) pageReference.getPage()).setYesNoModalResult(true);
        ...
        AjaxButton noButton = new AjaxButton("noButton", yesNoForm) {
			...
			@Override
            protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
				if (pageReference != null) ((ProductSystemEditor) pageReference.getPage()).setYesNoModalResult(false);
				yesNoModal.close(target);
            }
        };
