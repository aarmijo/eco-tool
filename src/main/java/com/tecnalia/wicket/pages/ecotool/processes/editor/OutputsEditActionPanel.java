...
public class OutputsEditActionPanel extends Panel {

	private static final long serialVersionUID = 1L;
	
	// Get logger
	private static final Logger logger = Logger.getLogger(OutputsEditActionPanel.class);
	 ...
	 */
	public OutputsEditActionPanel(String id, IModel<ExchangeDescriptor> model, ModalWindow editFlowModalWindow, PageReference pageReference)
	{
		super(id, model);
