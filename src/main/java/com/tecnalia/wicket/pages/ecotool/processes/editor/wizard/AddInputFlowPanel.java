...
public class AddInputFlowPanel extends Panel {
	...
	// Get logger
	private static final Logger logger = Logger.getLogger(AddInputFlowPanel.class);
	...
	private class FlowForm extends Form<FlowFormModel>
	{
		...
		public void onSubmit()
		{
			...
			logger.debug("Input flow added to product: " + processDescriptor.getName());	

		}
		
	}
	
	public AddInputFlowPanel(String id, ModalWindow addInputFlowModalWindow, PageReference pageReference) {
		super(id);
